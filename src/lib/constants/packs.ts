...
export const PACK_DEFINITIONS: PackDefinition[] = [
  ...
  {
    type: "MAYO_2X1",
    name: { en: "Mother's Month 2x1", es: "Mes de las Madres 2x1" },
    description: {
      en: "Mother's Month — 2 classes for the price of 1. A gift for her!",
      es: "Mes de las Madres — 2 clases por el precio de 1. Un regalo para ella!",
    },
    totalClasses: 2,
    priceCop: 80000,
    priceUsd: 21,
